...
class __crack__:
	...
	def __pler__(self):
		yan = input('\n[•] Choose : ')
		if yan == '':
			ABDULLAHI ('\Choose Error ')
			exit()
		elif yan in ('1', '01'):
			ABDULLAHI ('\n[•] Result OK saved to OK.txt')
			ABDULLAHI ('[•] Result CP saved to CP.txt')
			ABDULLAHI ('\n\tCrack Processing...\n')
			ABDULLAHI ('\n\tCrack Processing...\n\n');logo()
			with ThreadPoolExecutor(max_workers=35) as (_ngentot_gratis_):
...
banner="""\033[1;37m
 ...
 [*]=============================================
    ...
    Facebook : https://facebook.com/Mustacsim2006
    Team     : Somi + Zahid
    Connect  : +252611522943
 [*]=============================================
...
def dupcutter():
	os.system("xdg-open https://wa.me/+252611522943")
	time.sleep(3)
	readline___Public_Xml()
def sep():
	logo()
